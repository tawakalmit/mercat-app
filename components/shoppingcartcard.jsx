...
const DashboardCard = ({productname, stock, price, quantity, subtotal}) =>{
        ...
        <div className="mb-5">
            <div className="card h-auto w-36 border-solid border-2 border-lime-400 rounded-3xl p-2">
                ...
                <div className="gap-x-0 flex justify-between border-lime-400 border-solid border-y-2 text-center">
                    ...
                    <button className="w-11 h-5 bg-slate-400 text-white text-xs rounded-full md:w-20" onClick={(e) => handleEdit(e)}>Edit</button>
                    
                    <button className="w-11 h-5 bg-[#e74c3c] ml-2.5 text-white text-xs rounded-full md:w-20" onClick={(e) => handleDelete(e)}>Delete</button>
                    </div>
            </div>
        </div>
    )
